...
<div class="row">
<h3><?php echo __('Edit Hotel Rating'); ?></h3>
...
<div class="row">
    ...
    <div class="col-sm-12 col-md-12 col-xs-12">
        <div class="form-group">
            <?php echo $this->Form->input('review', array('type'=>'textarea', 'class'=>'ckeditor', 'div'=>false, 'id'=>'review_description', 'width'=>'100%')); ?>
        </div>
    </div>
</div>
...
<div class="row">
    ...
    <div class="col-sm-6 col-md-6 col-xs-6">
        <div class="form-group">
            <?php echo $this->Form->input('is_approvied', array('type'=>'select', 'class'=>'admin-add-edit-dropdown-big', 'div'=>false, 'options'=>array(0=>'No',1=>'Yes'))); ?>
        </div>
    </div>
</div>
