...
<div class="row">
<h3><?php echo __('Add Cms Content'); ?></h3>
<?php echo $this->Form->create('CmsContent', array('novalidate' => true,
					'inputDefaults'=>array(
...
<div class="col-sm-6 col-md-6 col-xs-6">
    ...
    <?php $conttype=array('about_us'=>'About Us', 'how_it_works'=>'How it works', 'faq'=>'Faq');
	///pr($conttype);?>
		<?php echo $this->Form->input('content_type', array('name'=>'data[CmsContent][content_type]','class'=>'admin-add-edit-dropdown-big', 'div'=>false, 'empty' => 'Select','options'=>$conttype)); ?>
	</div>
</div>
<div class="col-sm-6 col-md-6 col-xs-6">
	<div class="form-group">
...
<div class="col-sm-6 col-md-6 col-xs-6">
	<div class="form-group">
		<?php echo $this->Form->input('question', array('type'=>'text', 'class'=>'form-control', 'div'=>false)); ?>
	</div>
</div>
</div>
<div class="row">
<div class="col-sm-12 col-md-12 col-xs-12">
	<div class="form-group">
		<?php echo $this->Form->input('description', array('type'=>'textarea', 'class'=>'form-control', 'div'=>false, 'id'=>'content_description', 'width'=>'100%')); ?>
	</div>
</div>
</div>
<div class="row">
