...
$(document).ready(function(){
		...
		//var editor = $('#hotel_description').get;
...
<div class="row">
<h3><?php echo __('Add Hotel'); ?></h3>
<?php echo $this->Form->create('Hotel', array('novalidate' => true,
					'inputDefaults'=>array(
...
<div class="row">
    <div class="col-sm-12 col-md-12 col-xs-12">
        <div class="form-group">
            <?php echo $this->Form->input('description', array('type'=>'textarea', 'class'=>'form-control', 'div'=>false, 'id'=>'hotel_description', 'width'=>'100%')); ?>
        </div>
	</div>
</div>
<div class="row">
