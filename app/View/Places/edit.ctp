...
<div class="row">
<h3><?php echo __('Edit Place'); ?></h3>
<?php echo $this->Form->create('Place', array('novalidate' => true,
					'inputDefaults'=>array(
...
<div class="col-sm-6 col-md-6 col-xs-6">
	<div class="form-group">
		<?php echo $this->Form->input('state_id', array('type'=>'text', 'class'=>'form-control', 'div'=>false)); ?>
	</div>
</div>
<div class="col-sm-6 col-md-6 col-xs-6">
	<div class="form-group">
